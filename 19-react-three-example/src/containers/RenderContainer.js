/*
 * The actual render handles all of the WebGL configuration, but the container provides a node that will handle loading
 * data in preparation for passing it to the Render node. Essentially, this addresses the problem "the Render node
 * needs data, but I haven't loaded it yet!"
 */
